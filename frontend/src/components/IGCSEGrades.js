...
class IGCSEGrades extends Component {
                ...
                <div className='overflow-auto md:mx-auto mt-4 p-10 border border-gray-300 rounded bg-white'>
                    ...
                    <p className='text-base text-center text-gray-600 mb-6'>
                        ...
                        <span className='text-red-500 font-semibold'>
                            ...
                            for any programme is grade letter C. Anything <br />
                            after C makes you ineligible for any programme.
                        </span>
                    </p>
                        ...
                        {subjects.map((subject, index) => (
                            ...
                            <div key={index}>
                                ...
                                <select
                                    ...
                                    required={false}
                                >
                                    <option value="" selected disabled>Select letter Grade</option>
