    ...
    render() {
        ...
        return (
            ...
            <div className='pb-6'>
                ...
                <div className="overflow-auto mx-40 mt-4 p-10 pt-6 border border-gray-300 rounded shadow-sm bg-white">

                    <h1 className='text-center text-space text-xl font-semibold mb-4'>Step 1</h1>
                    <p className=' text-center text-base mb-4 text-gray-600'>Choose one curriculum option</p>
